...
public class MeterInfo extends JFrame implements ActionListener {
    ...
    MeterInfo(String meternumber) {
        ...
        JLabel lblemails = new JLabel("Days30");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/meter.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String query = "insert into meter_infor values('" + meter + "','" + location + "','" + type + "','" + code + "','" + typebill + "','" + days + "')";
